...
namespace ModelsClassLibrary.ModelsNS.SharedNS
{
    public class SystemInProccessPurchaseOrders : IMenuItemHelper
    {
        ...
        public string MenuItem
        {
            get
            {
                string content = ConfigurationManager.AppSettings["menu.system.PurchaseOrders.InProccess.MenuItem"];
        ...
        public string ToolTip
        {
            get
            {
                string content = ConfigurationManager.AppSettings["menu.system.PurchaseOrders.InProccess.ToolTip"];
                string str = string.Format(content, Money, Quantity);
                return str;
            }
        }
