...
namespace ModelsClassLibrary.ModelsNS.SharedNS
{
    public class SystemBackSaleOrders : IMenuItemHelper
    {
        ...
        public string MenuItem
        {
            get
            {
                string content = ConfigurationManager.AppSettings["menu.system.SaleOrders.Back.MenuItem"];
        ...
        public string ToolTip
        {
            get
            {
                string content = ConfigurationManager.AppSettings["menu.system.SaleOrders.Back.ToolTip"];
                string str = string.Format(content, Money, Quantity);
                return str;
            }
        }
