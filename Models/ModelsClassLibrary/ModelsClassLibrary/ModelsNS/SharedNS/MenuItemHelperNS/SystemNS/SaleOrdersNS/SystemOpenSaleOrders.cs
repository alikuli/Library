...
namespace ModelsClassLibrary.ModelsNS.SharedNS
{
    public class SystemOpenSaleOrders : IMenuItemHelper
    {
        ...
        public string MenuItem
        {
            get
            {
                string content = ConfigurationManager.AppSettings["menu.system.SaleOrders.Open.MenuItem"];
        ...
        public string ToolTip
        {
            get
            {
                string content = ConfigurationManager.AppSettings["menu.system.SaleOrders.Open.ToolTip"];
                string str = string.Format(content, Money, Quantity);
                return str;
            }
        }
