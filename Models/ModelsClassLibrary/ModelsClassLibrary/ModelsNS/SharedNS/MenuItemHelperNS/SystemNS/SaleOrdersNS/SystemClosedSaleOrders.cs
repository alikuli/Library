...
namespace ModelsClassLibrary.ModelsNS.SharedNS
{
    public class SystemClosedSaleOrders : IMenuItemHelper
    {
        ...
        public string MenuItem
        {
            get
            {
                string content = ConfigurationManager.AppSettings["menu.system.SaleOrders.Closed.MenuItem"];
        ...
        public string ToolTip
        {
            get
            {
                string content = ConfigurationManager.AppSettings["menu.system.SaleOrders.Closed.ToolTip"];
                string str = string.Format(content, Money, Quantity);
                return str;
            }
        }
