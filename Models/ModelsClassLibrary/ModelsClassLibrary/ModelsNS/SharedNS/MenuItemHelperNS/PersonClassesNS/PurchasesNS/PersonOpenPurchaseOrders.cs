...
namespace ModelsClassLibrary.ModelsNS.SharedNS
{
    public class PersonOpenPurchaseOrders : IMenuItemHelper
    {
        ...
        public string MenuItem
        {
            get
            {
                string content = ConfigurationManager.AppSettings["menu.person_OpenPurchaseOrders_MenuItem"];
        ...
        public string ToolTip
        {
            get
            {
                string content = ConfigurationManager.AppSettings["menu.person_OpenPurchaseOrders_ToolTip"];
                string str = string.Format(content, Money, Quantity);
                return str;
            }
        }
