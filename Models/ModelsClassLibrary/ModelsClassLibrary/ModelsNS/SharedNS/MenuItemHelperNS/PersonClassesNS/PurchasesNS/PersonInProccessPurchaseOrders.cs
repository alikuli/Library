...
namespace ModelsClassLibrary.ModelsNS.SharedNS
{
    public class PersonInProccessPurchaseOrders : IMenuItemHelper
    {
        ...
        public string MenuItem
        {
            get
            {
                string content = ConfigurationManager.AppSettings["menu.person_InProccessPurchaseOrders_MenuItem"];
        ...
        public string ToolTip
        {
            get
            {
                string content = ConfigurationManager.AppSettings["menu.person_InProccessPurchaseOrders_ToolTip"];
                string str = string.Format(content, Money, Quantity);
                return str;
            }
        }
