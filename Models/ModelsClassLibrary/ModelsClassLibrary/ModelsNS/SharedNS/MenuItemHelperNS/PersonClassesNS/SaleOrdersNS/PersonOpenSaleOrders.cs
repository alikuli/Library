...
namespace ModelsClassLibrary.ModelsNS.SharedNS
{
    public class PersonOpenSaleOrders : IMenuItemHelper
    {
        ...
        public string MenuItem
        {
            get
            {
                string content = ConfigurationManager.AppSettings["menu.personOpenSaleOrders_MenuItem"];
        ...
        public string ToolTip
        {
            get
            {
                string content = ConfigurationManager.AppSettings["menu.personOpenSaleOrders_ToolTip"];
                string str = string.Format(content, Money, Quantity);
                return str;
            }
        }
