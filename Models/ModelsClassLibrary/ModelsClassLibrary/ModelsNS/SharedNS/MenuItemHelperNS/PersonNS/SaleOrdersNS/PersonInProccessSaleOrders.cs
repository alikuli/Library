...
namespace ModelsClassLibrary.ModelsNS.SharedNS
{
    public class PersonInProccessSaleOrders : IMenuItemHelper
    {
        ...
        public string MenuItem
        {
            get
            {
                string content = ConfigurationManager.AppSettings["menu.person.SaleOrders.InProccess.MenuItem"];
        ...
        public string ToolTip
        {
            get
            {
                string content = ConfigurationManager.AppSettings["menu.person.SaleOrders.InProccess.ToolTip"];
                string str = string.Format(content, Money, Quantity);
                return str;
            }
        }
