...
namespace ModelsClassLibrary.ModelsNS.SharedNS
{
    public class PersonCanceledPurchaseOrders : IMenuItemHelper
    {
        ...
        public string MenuItem
        {
            get
            {
                string content = ConfigurationManager.AppSettings["menu.person.PurchaseOrders.Canceled.MenuItem"];
        ...
        public string ToolTip
        {
            get
            {
                string content = ConfigurationManager.AppSettings["menu.person.PurchaseOrders.Canceled.ToolTip"];
                string str = string.Format(content, Money, Quantity);
                return str;
            }
        }
