...
namespace ModelsClassLibrary.ModelsNS.SharedNS
{
    public class SystemInProccessSaleOrders : IMenuItemHelper
    {
        ...
        public string MenuItem
        {
            get
            {
                string content = ConfigurationManager.AppSettings["menu.system_InProccessOrders_MenuItem"];
        ...
        public string ToolTip
        {
            get
            {
                string content = ConfigurationManager.AppSettings["menu.system_InProccessOrders_ToolTip"];
                string str = string.Format(content, Money, Quantity);
                return str;
            }
        }
