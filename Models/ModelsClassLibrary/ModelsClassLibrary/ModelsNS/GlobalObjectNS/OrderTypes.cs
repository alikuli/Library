...
namespace ModelsClassLibrary.ModelsNS.DocumentsNS.GlobalObjectNS
{
    public class OrderTypes
    {
        public OrderTypes()
        {
            ...
            BeingPreparedForShipmentBySeller = new MoneyCountItemClass();
            ReadyForPickup = new MoneyCountItemClass();
            CourierAcceptedByBuyerAndSeller = new MoneyCountItemClass();
            CourierComingToPickUp = new MoneyCountItemClass();
            PickedUp = new MoneyCountItemClass();
            Enroute = new MoneyCountItemClass();
        ...
        public MoneyCountItemClass BeingPreparedForShipmentBySeller { get; set; }

        //Once package is ready for shipping, seller confirms that package is ready for pickup
        public MoneyCountItemClass ReadyForPickup { get; set; }
        public MoneyCountItemClass CourierAcceptedByBuyerAndSeller { get; set; }

        //Courier confirms they are going to pick up the package
        public MoneyCountItemClass CourierComingToPickUp { get; set; }

        //the package has been picked up by the courier
        public MoneyCountItemClass PickedUp { get; set; }
        public MoneyCountItemClass Enroute { get; set; }
