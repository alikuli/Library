...
namespace UowLibrary.MenuNS.MenuStateNS.MenuStatesNS
{
    ...
    {
        public EditMenuPath2(MenuPathMain menuPathMain, Product product, ProductChild productChild, MenuENUM menuEnum, LikeUnlikeParameters likeUnlikesCounter, string userId, string userName)
