...
{
    public class EditMenuProductChild : MenuManagerAbstract
    {

        public EditMenuProductChild(MenuPathMain menuPathMain, Product product, ProductChild productChild, MenuENUM menuEnum)
