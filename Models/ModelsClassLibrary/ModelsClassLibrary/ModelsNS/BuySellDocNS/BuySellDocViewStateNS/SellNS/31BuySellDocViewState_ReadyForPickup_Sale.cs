...
{
    public class BuySellDocViewState_ReadyForPickup_Sale : BuySellDocViewState_Abstract
    {

        public BuySellDocViewState_ReadyForPickup_Sale(string customerPersonId, string sellerPersonId)
            : base(BuySellDocStateENUM.ReadyForPickup, BuySellDocumentTypeENUM.Sale, customerPersonId, sellerPersonId)
        {
        ...
        public override string OL_Cancel_Button_ToolTip { get { return "Cancel will return you to 'Being Prepared For Shipment."; } }
        ...
        public override string OL_ToolTip_Edit { get { return "Select your courier"; } }
