...
{
    public class BuySellDocViewState_RequestUnconfirmed_Delivery : BuySellDocViewState_Abstract
    {

        public BuySellDocViewState_RequestUnconfirmed_Delivery(string customerPersonId, string sellerPersonId)
            : base(BuySellDocStateENUM.RequestUnconfirmed, BuySellDocumentTypeENUM.Delivery, customerPersonId, sellerPersonId)
        {
