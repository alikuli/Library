...
namespace ModelsClassLibrary.ModelsNS.DocumentsNS.BuySellDocNS.BuySellDocViewStateNS
{
    ...
    /// </summary>
    public class BuySellDocViewState_Delivered_Delivery : BuySellDocViewState_Abstract
    {
        public BuySellDocViewState_Delivered_Delivery(string customerPersonId, string sellerPersonId)
            : base(BuySellDocStateENUM.Delivered, BuySellDocumentTypeENUM.Delivery, customerPersonId, sellerPersonId)
        {
