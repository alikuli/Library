...
{
    public class BuySellDocViewState_OptedOutOfSystem_Purchase : BuySellDocViewState_Abstract
    {

        public BuySellDocViewState_OptedOutOfSystem_Purchase(string customerPersonId, string sellerPersonId)
