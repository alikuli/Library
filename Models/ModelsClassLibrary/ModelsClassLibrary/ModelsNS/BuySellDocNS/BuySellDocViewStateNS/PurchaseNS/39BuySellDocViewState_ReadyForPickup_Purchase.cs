...
{
    public class BuySellDocViewState_ReadyForPickup_Purchase : BuySellDocViewState_Abstract
    {
        public BuySellDocViewState_ReadyForPickup_Purchase(string customerPersonId, string sellerPersonId)
            : base(BuySellDocStateENUM.ReadyForPickup, BuySellDocumentTypeENUM.Purchase, customerPersonId, sellerPersonId)
        {
