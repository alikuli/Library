...
{
    public class BuySellDocViewState_CourierComingToPickUp_Purchase : BuySellDocViewState_Abstract
    {

        public BuySellDocViewState_CourierComingToPickUp_Purchase(string customerPersonId, string sellerPersonId)
            : base(BuySellDocStateENUM.CourierComingToPickUp, BuySellDocumentTypeENUM.Purchase, customerPersonId, sellerPersonId)
        {
