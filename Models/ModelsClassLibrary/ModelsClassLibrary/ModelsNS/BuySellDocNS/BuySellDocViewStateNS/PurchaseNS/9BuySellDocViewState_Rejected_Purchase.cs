...
{
    public class BuySellDocViewState_Rejected_Purchase : BuySellDocViewState_Abstract
    {

        public BuySellDocViewState_Rejected_Purchase(string customerPersonId, string sellerPersonId)
            : base(BuySellDocStateENUM.Rejected, BuySellDocumentTypeENUM.Purchase, customerPersonId, sellerPersonId)
        { }
