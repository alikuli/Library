...
{
    public class BuySellDocViewState_CourierAcceptedByBuyerAndSeller_Salesman : BuySellDocViewState_Abstract
    {
        public BuySellDocViewState_CourierAcceptedByBuyerAndSeller_Salesman(string customerPersonId, string sellerPersonId)
            : base(BuySellDocStateENUM.CourierAcceptedByBuyerAndSeller, BuySellDocumentTypeENUM.Salesman, customerPersonId, sellerPersonId)
        {
