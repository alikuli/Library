...
{
    public class BuySellDocViewState_RequestConfirmed_Salesman : BuySellDocViewState_Abstract
    {

        public BuySellDocViewState_RequestConfirmed_Salesman(string customerPersonId, string sellerPersonId)
            : base(BuySellDocStateENUM.RequestConfirmed, BuySellDocumentTypeENUM.Salesman, customerPersonId, sellerPersonId)
        {
