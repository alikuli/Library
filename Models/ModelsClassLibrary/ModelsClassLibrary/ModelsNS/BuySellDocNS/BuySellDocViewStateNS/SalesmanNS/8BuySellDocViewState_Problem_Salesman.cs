...
{
    public class BuySellDocViewState_Problem_Salesman : BuySellDocViewState_Abstract
    {
        public BuySellDocViewState_Problem_Salesman(string customerPersonId, string sellerPersonId)
            : base(BuySellDocStateENUM.Problem, BuySellDocumentTypeENUM.Salesman, customerPersonId, sellerPersonId)
        {
