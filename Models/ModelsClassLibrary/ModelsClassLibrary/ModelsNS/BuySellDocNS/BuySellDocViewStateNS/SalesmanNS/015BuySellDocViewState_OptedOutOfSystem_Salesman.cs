...
{
    public class BuySellDocViewState_OptedOutOfSystem_Salesman : BuySellDocViewState_Abstract
    {

        public BuySellDocViewState_OptedOutOfSystem_Salesman(string customerPersonId, string sellerPersonId)
            : base(BuySellDocStateENUM.OptedOutOfSystem, BuySellDocumentTypeENUM.Salesman, customerPersonId, sellerPersonId)
        {
