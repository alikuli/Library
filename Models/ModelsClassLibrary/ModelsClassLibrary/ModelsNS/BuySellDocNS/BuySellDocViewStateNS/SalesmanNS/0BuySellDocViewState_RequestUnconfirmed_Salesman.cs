...
{
    public class BuySellDocViewState_RequestUnconfirmed_Salesman : BuySellDocViewState_Abstract
    {

        public BuySellDocViewState_RequestUnconfirmed_Salesman(string customerPersonId, string sellerPersonId)
            : base(BuySellDocStateENUM.RequestUnconfirmed, BuySellDocumentTypeENUM.Salesman, customerPersonId, sellerPersonId)
        {
        ...
        public override AddressDetailToShowENUM HD_AddressDetailToShow { get { return AddressDetailToShowENUM.OnlyAddressNoPhoneOrEmail; } }
