...
namespace ModelsClassLibrary.ModelsNS.CashNS.PenaltyNS
{
    ...
    public class PersonPayingPenalty
    {
        public PersonPayingPenalty(BuySellDoc buysSellDoc)
        {
            ...
            Salesman_Owner = new Person();
            Salesman_Customer = new Person();
            Salesman_Deliveryman = new Person();
            System_Freight = new Person();
            System_Sale = new Person();
            System_ExtraCommission = new Person();
