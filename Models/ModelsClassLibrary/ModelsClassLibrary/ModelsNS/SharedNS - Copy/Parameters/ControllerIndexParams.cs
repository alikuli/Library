...
namespace ModelsClassLibrary.ModelsNS.SharedNS
{
    ...
    public class ControllerIndexParams
    {
        ...
        public ControllerIndexParams(string searchFor, string selectedId, SortOrderENUM sortBy, MenuLevelENUM menuLevel, string id, string productCat1Id, string productCat2Id, string productCat3Id, ICommonWithId entity)
        {
            Entity = entity;
            SearchFor = searchFor;
            SortBy = sortBy;
