...
{
    public class ProductCat2DAL:Repositry<ProductCat2>
    {

        public ProductCat2DAL(ApplicationDbContext db, IUser user)
            : base(db, user)
        {
        ...
        public override void Delete(ProductCat2 entity)
        {
