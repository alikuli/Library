...
namespace InitializeClassLibrary.InitializeNS
{
    public class InitializeUser
    {
        ...
        public void Initialize()
        {
            ...
            string errorStr = "";
            string countryAbbrv = AppManager.GetDefaultCountryAbbreviation();
            ...
            string countryAbbreviation = AliKuli.Utilities.AppConfigHelper.GetDefaultCountryAbbreviation();
            ...
            Add("923314474121", "@liKuli786!", serviceManRole, countryAbbrv, "1234567890123", "Ali", "1", "Main Harbanspura Road", "Lahore", "Lahore", "Punjab", "Pakistan", false, "Kuli", "Aminuddin", "Gulkali", "12345678", "3314474999", "Kokopala.com", "alikuli62@gmail.com", SexENUM.Male, SonOfWifeOfDotOfENUM.SonOf, "Parvez Amin", "Initial User", "Owner of House");

            Add("3334416272", "@liKuli786!", hiringManRole, countryAbbrv, "1234567890120", "Aila", "2", "Gulberg", "Lahore", "Lahore", "Punjab", "Pakistan", false, null, "Azhar", "Gulkali", null, "3314474998", "Aila.com", "alikuli@yahoo.com", SexENUM.Female, SonOfWifeOfDotOfENUM.DaughterOf, "Parvez Amin", "Initial User", "Accounbt Receivable");

            Add("03314474123", "@liKuli786!", salesManRole, countryAbbrv, "1234567890125", "Khursheed", "1", "Abbot Road", "Lahore", "Lahore", "Punjab", "Pakistan", false, "Mughal", "Khan", "Mountain Pass", "0987654321", "3314474997", "arco.com", "alikuli62@gmail.com", SexENUM.Male, SonOfWifeOfDotOfENUM.SonOf, "Mughal", "Initial User", "Account payable");
