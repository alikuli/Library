...
namespace UowLibrary.AddressNS
{
    public partial class AddressBiz 
    {
        ...
        /// </summary>
        public override System.Linq.IQueryable<AddressWithId> GetDataToCheckDuplicateName(AddressWithId entity)
        {
            var dataSet = FindAll().Where(x => x.UserId == entity.UserId);
            return dataSet;
