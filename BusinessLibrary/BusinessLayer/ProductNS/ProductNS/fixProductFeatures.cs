...
namespace UowLibrary.ProductNS
{
    public partial class ProductBiz
    {
        ...
        public void FixProductFeatures(IProduct iproduct)
        {
            ...
            //Note. This will remove features from the product that are not features in the MenuPath.
            //I did this for consistancy.
            ...
            List<ProductFeature> productFeaturesToBeAdded = getProductFeaturesWhichAreInMenuPathButNotInProduct(allcurrentProductFeautres, allfeautresAsPerMenuPath, iproduct);

            //removeProductFeaturesFrom(iproduct, productFeaturesToBeRemoved);
            addProductFeaturesTo(iproduct, productFeaturesToBeAdded);
            markRequiredFeaturesAsDeleteNotAllowed(iproduct, allfeautresAsPerMenuPath);
        }
        ...
        private List<ProductFeature> getAllCurrentProductFeaturesFor(IProduct iproduct)
        {
            ...
            foreach (ProductFeature item in lst)
            {
                item.MetaData.IsDeleteLocked = false;
            }
            return lst;
        }
