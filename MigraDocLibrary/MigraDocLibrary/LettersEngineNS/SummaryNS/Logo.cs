...
namespace MigraDocLibrary.FactoryNS
{
    ...
    public partial class LetterEngine
    {
        ...
        //    //numberOfLettersPara.Format.Alignment = ParagraphAlignment.Center;
        ...
        private void summaryLetter_Logo(Section section, AddressVerificationModel_Header header)
        {
            ...
            //var header_InProcessDate_Cell = head5rRows[3].Cells[3];
            ...
            Paragraph websiteAddy = header_Logo_Cell.AddParagraph(header.WebsiteAddress);
