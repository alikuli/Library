...
function HideMenuCol() {
    $("#btnCol").removeClass("d-none");
    $("#menuCol").addClass("d-none");

    $("#mainCol").removeClass("col-9");
    $("#mainCol").addClass("col-10");
    return false;


}

function showMenuCol() {
    $("#btnCol").addClass("d-none");
    $("#menuCol").removeClass("d-none ");

    $("#mainCol").removeClass("col-10");
    $("#mainCol").addClass("col-9");
    return false;
}